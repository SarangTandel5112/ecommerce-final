...
export const ScrollAnimation = () => {
    ...
    // top panel
    const topPanel: any = document.querySelector(".sb-top-bar-frame");
    const infoBar: any = document.querySelector(".sb-info-bar");
    const miniCart: any = document.querySelector(".sb-minicart");
