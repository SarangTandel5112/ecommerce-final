    ...
    return (
        <>
            ...
            <div className="sb-top-bar-frame">
                ...
                <div className="container">
                    <div className="sb-top-bar">
                        ...
                        <div className="sb-right-side">
                            <nav
                                id="sb-dynamic-menu"
                                className="sb-nav sb-menu-transition"
                            >
                                <ul
                                    className={`sb-navigation ${
                                        mobileMenu ? "sb-active" : ""
                                    }`}
                                >
                                    {AppData.header.menu.map(
                                        (item: any, index: any) => (
                                            <li
                ...
                {/* info bar */}
                <div
                    className={`sb-info-bar ${miniSidebar ? "sb-active" : ""}`}
                >
                    <MiniSidebar />
                </div>
                {/* info bar end */}
