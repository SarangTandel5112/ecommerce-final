...
const MenuItem = ({ item, index, noImage, marginBottom }: any) => {
    const stars = ["", "", "", "", ""];

    const [img, setImg] = useState(false);
    const [imgValue, setImgValue]: any = useState([]);
            ...
            >
                ...
                <div className="sb-card-tp">
                    ...
                    <div className="sb-price">
                        <sub>{item.currency}</sub> {item.price}
                    </div>
                </div>
                    ...
                    <ul className="sb-stars">
                        {stars
                            ...
                            .map((star_item, star_key) => (
                                <li
                                    key={`products-item-${index}-rating-star-${star_key}`}
                                >
